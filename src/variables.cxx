...
g++ -I"$NGM_ROOT/include" -I"$NGM_ROOT/modules" -I"$NGM_ROOT/modules/cup" -Wall -I/usr/local/include -I/usr/include/eigen3 -L/usr/local/lib ../src/variables.cxx -o ../bin/vrb -lgsl -lgslcblas -lm -larmadillo
*/
