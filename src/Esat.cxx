...
using namespace std;
/*
g++ -Iextern/nano_geo_matrix/include -Iextern/nano_geo_matrix/modules -Wall -I/usr/local/include -I/usr/include/eigen3 -L/usr/local/lib ../src/Esat.cxx -o ../bin/Esat -lgsl -lgslcblas -lm -larmadillo
*/
