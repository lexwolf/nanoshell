...
g++ -I"$NGM_ROOT/include" -I"$NGM_ROOT/modules" -I"$NGM_ROOT/modules/cup" -Wall -I/usr/include/ -I/usr/include/eigen3 -L/usr/local/lib ../src/nanoshell_anl.cxx -o ../bin/nsa -lgsl -lgslcblas -lm -larmadillo
*/
