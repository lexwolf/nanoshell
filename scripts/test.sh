...
# Format expected:
# a Dome ome_g G omemi omema mtl mdl active sol E0 rap hst
read -r a Dome ome_g G omemi omema mtl mdl active sol E0 rap hst < "$INPUT_FILE"
...
write_input() {
  ...
  local omema_val="2.9"
    {
    echo "$a $Dome $ome_g_val $G_val $omemi_val $omema_val $mtl $mdl $active $sol $E0 $rap $hst"
