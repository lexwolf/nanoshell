...
show_help() {
    ...
    echo "  -rho  --radius-ratio  Set the radius ratio (rho) used in calculations"
    echo ""
    echo "Arguments:"
...
read  a  Dome  ome21  G  omemi  omema  metal  model  gain_model  solvent E0 rho host < ../data/input/nanosphere_eV.dat
rho_tmp=$rho
...
if [ -n "$rho_override" ]; then
    rho_tmp=$rho_override
fi
fro=(`./../bin/fro`)
omeG=${fro[0]}
Gth=${fro[1]}
...
{
    echo "$a $Dome $omeG $G $omi $oma $metal $model $gain_model $solvent $none $rho_tmp $host"
    echo "# a Dome omeG G omi oma metal model gain_model solvent none rho_tmp host"
...
focurr="rho"$rho_tmp"-"$host"-at-"$metal"-in-"$solvent"/"
echo "> ...Done!"
echo
...
{
    echo "$a $Dome $omeG $G $ex1 $ex2 $metal $model $gain_model $solvent $none $rho_tmp $host"
    echo "# a Dome omeG G ex1 ex2 metal model gain_model solvent none rho_tmp host"
    echo "** WARNING: This file was automatically edited by $0."
    echo "** Do not edit this file manually until the process ends."
} > ../data/input/nanosphere_eV.dat
...
for ii in {0..20..1}; do
    ...
    {
        echo "$a $Dome $omeG $mG $ex1 $ex2 $metal $model $gain_model $solvent $E0 $rho_tmp $host"
        echo "# a Dome omeG mG ex1 ex2 metal model gain_model solvent E0 rho_tmp host"
        echo "** WARNING: This file was automatically edited by $0."
        echo "** Do not edit this file manually until the process ends."
    } > ../data/input/nanosphere_eV.dat
    ./../bin/oap
    {
        echo "$a $Dome $omeG $mG $omi $oma $metal $model $gain_model $solvent $E0 $rho_tmp $host"
        echo "# a Dome omeG mG omi oma metal model gain_model solvent E0 rho_tmp host"
        echo "** WARNING: This file was automatically edited by $0."
        echo "** Do not edit this file manually until the process ends."
    } > ../data/input/nanosphere_eV.dat
...
{
    echo "$a $Dome $ome21 $G $omemi $omema $metal $model $gain_model $solvent $E0 $rho $host"
    echo "# a Dome ome21 G omemi omema metal model gain_model solvent E0 rho host"
} > ../data/input/nanosphere_eV.dat
echo "> ...Done!"
