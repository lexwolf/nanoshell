...
read a Dome ome_g G omemi omema metal model gain_model solvent E0 rho host < "$file_path"
orig_omemi="$omemi"
orig_omema="$omema"
...
{
    echo "$a $Dome $ome_g $G $orig_omemi $orig_omema $metal $model $gain_model $solvent $E0 $rho $host"
    echo "# a Dome ome_g G omemi omema metal model gain_model solvent E0 rho host"
} > "$file_path"
echo "> done!"
