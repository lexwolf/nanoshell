...
read a Dome ome_g G omemi omema metal model gain_model solvent E0 rap host < "$file_path"
orig_omemi="$omemi"
orig_omema="$omema"
...
write_input() {
    ...
    local omema_val="$4"
    {
        echo "$a $Dome $ome_g_val $G_val $omemi_val $omema_val $metal $model $gain_model $solvent $E0 $rap $host"
        echo "# a Dome ome_g G omemi omema metal model gain_model solvent E0 rap host"
...
{
    echo "$a $Dome $ome_g $G $orig_omemi $orig_omema $metal $model $gain_model $solvent $E0 $rap $host"
    echo "# a Dome ome_g G omemi omema metal model gain_model solvent E0 rap host"
} > "$file_path"
echo "> done!"
